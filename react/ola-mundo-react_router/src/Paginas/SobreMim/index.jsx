...
import fotoSobreMimCapa from "assets/sobre_mim_capa.png";
import foto from "assets/aurelio Capingana.jpg";

const SobreMim = () => {
  return (
    <PostModelo fotoCapa={fotoSobreMimCapa} titulo="Sobre Mim">
      <h3 className={styles.subtitulo}>Olá, Eu sou o Aurélio Capingana...</h3>

      <img
        src={foto}
        alt="Foto do Aurélio Capingana"
        className={styles.fotoSobreMim}
      />

<p className={styles.paragrafo}>
                Oi, tudo bem? Estou começando minha caminhada, estou cursando <strong>Engenharia de Software</strong>.
            </p>
            <p className={styles.paragrafo}>
